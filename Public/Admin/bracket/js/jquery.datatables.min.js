...
(function(za, O, l) {
	var N = function(h) {
		...
		function sb(a) {
			...
			k("mDataProp_" + g, i),
			d.bFilter && (k("sSearch_" + g, m.sSearch), k("bRegex_" + g, m.bRegex), k("bSearchable_" + g, n.bSearchable)),
		...
		function xb(a) {
			...
			for (f = a.aoData.length; d < f; d++) if (h = a.aoData[d], !h._aFilterData) {
				...
				c.bSearchable ? (i = A(a, d, e, "filter"), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "",
				i.indexOf && -1 !== i.indexOf("&") && (qa.innerHTML = i, i = Wb ? qa.textContent: qa.innerText),
		...
		function W(a) {
			...
			if (q.outerWidth() < g) {
				...
				if (v && (i.scrollHeight > i.offsetHeight || "scroll" == o.css("overflow-y"))) M.width = s(t - f); ("" === c || "" !== d) && P(a, 1, "Possible column misalignment", 6)
			} else t = "100%";
			k.width = s(t);
			j.width = s(t);
		...
		q.prototype = {
			...
			iterator: function(a, b, c) {
				...
				f = 0;
				for (g = n.length; f < g; f++) if ("table" === b) e = c(n[f], f),
				e !== l && d.push(e);
				...
				e !== l && d.push(e);
					...
					h = 0;
					for (i = o.length; h < i; h++) e = o[h],
					e = "cell" === b ? c(n[f], e.row, e.column, f, h) : c(n[f], e, f, h, m),
					e !== l && d.push(e)
				}
					...
					if (a === l) e = e.bVisible;
						...
						if (e.bVisible !== a) {
							if (a) {
								...
								j = 0;
								for (i = g.length; j < i; j++) n = g[j].nTr,
								f = g[j].anCells,
		...
		function(a) {
			...
			function(b) {
				...
				f.children().detach();
				f.append(m);
				i.css("width", b.sDestroyWidth).removeClass(d.sTable); (o = b.asDestroyStripes.length) && f.children().each(function(a) {
